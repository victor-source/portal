<?php include "includes/header.php"?>
    ...
    <main class="main-area fix">
        ...
        <section class="banner-area-two banner-bg-two tg-motion-effects" data-background="assets/img/banner/banner_bg02.png">
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content-two">
                            <h3 class="title" data-aos="fade-right" data-aos-delay="400">
                                Empowering ,
                                <span class="position-relative text-light" style="background-color: #FFC738; border-radius:15px 5px 15px 5px;">                                    
                                    Education
                                </span> 
            ...
            <img src="assets/img/banner/h2_banner_shape03.svg" alt="shape" class="line-shape-two" data-aos="fade-right" data-aos-delay="1600">
        </section>
        <!-- banner-area-end -->
                            ...
                            <div class="features__item-two">
                                <div class="features__content-two">
                                    <div class="content-top">
                                        ...
                                        <h2 class="title">Smart Administration</h2>
                                    </div>
                                    <p>Effortlessly manage students, staff, and administrative tasks, freeing up valuable time for educational priorities.</p>
                                </div>
                            ...
                            <div class="features__item-two">
                                <div class="features__content-two">
                                    <div class="content-top">
                                        ...
                                        <h2 class="title">Parent-School Connection</h2>
                                    </div>
                                    <p>Enhance communication with parents through real-time updates and announcements, with bulk SMS and e-Mails fostering stronger school-parent partnerships.</p>
                                </div>
                                <div class="features__item-shape">
                                    <img src="assets/img/others/features_item_shape.svg" alt="img" class="injectable">
                                </div>
                            ...
                            <div class="features__item-two">
                                <div class="features__content-two">
                                    <div class="content-top">
                                        ...
                                        <h2 class="title">Instant Grading & Results</h2>
                                    </div>
                                    <p>Streamline result management and grading with our intuitive platform, ensuring accuracy and efficiency.</p>
                                </div>
                                <div class="features__item-shape">
                                    <img src="assets/img/others/features_item_shape.svg" alt="img" class="injectable">
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            <div class="section__title">
                                ...
                                <h2 class="title">
                                    A top tier school management and 
                            ...
                            <ul class="about__info-list list-wrap">
                                <li class="about__info-list-item">
                                    ...
                                    <p class="content">Seamless Efficiency</p>
                                </li>
                                <li class="about__info-list-item">
                                    <i class="flaticon-angle-right"></i>
                                    <p class="content">Innovative Security</p>
                                </li>
                                <li class="about__info-list-item">
                                    <i class="flaticon-angle-right"></i>
                                    <p class="content">Tailored for Excellence</p>
                                </li>
                            </ul>
                            <div class="tg-button-wrap">
                                <a href="" class="btn arrow-btn">Get me onboard now! <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-9">
                        <div class="about__images work__images">
                            ...
                            <a href="../../watch.html?v=b2Az7_lLh3g" class="popup-video">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8">
                        <div class="newsletter__content">
                            <h2 class="title">Want to stay <span>informed</span> about <br> new <span>features & updates?</span></h2>
